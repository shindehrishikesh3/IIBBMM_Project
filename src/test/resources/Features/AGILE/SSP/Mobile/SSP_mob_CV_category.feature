@mob @content @category
Feature: Category content validations in Mobile

  #Author: Soumen Maity
  @Sprint66 @SSP1061 @SSP1062 @live @api
  Scenario Outline: To verify contents of the category pages <store> <category>
    ...
    And open "TITLE_LINK" url for "<category>" category from json "CategoryContents_EN.json" in mobile
    And verify "<category>" category description with "CategoryPage.contents_text" in mobile
    And verify hyperlinked text in the description with "CategoryPage.contentInner_link" for category "<category>" if any in mobile
  ...
  Scenario Outline: To verify contents of the category pages <store> <category>
    ...
    And user wait "medium" duration for "CategoryPage.category_heading" element to "appear"
    And verify "<category>" category description with "CategoryPage.categoryContent_text"
    And verify hyperlinked text in the description with "CategoryPage.categoryContentURL_link" for category "<category>" if any
    ...
    Examples: 
      ...
      | en-DK | Earthing            |
      | en-PT | Dusters             |
      | en-HU | Domestic Switches   |
      | ie    | Developers          |
      | il    | Locks & Accessories |
      | en-SK | Line Reactors       |
      | en-DE | Line Conditioners   |
      | en-ES | Latches             |
    ...
    Examples: 
      ...
      | au    | Dusters             |
      | sg    | Electromagnetic     |
      | ph    | Line Conditioners   |
      | my    | Locks & Accessories |
      | nz    | Latches             |
      | au    | Line Conditioners   |
  ...
  @Sprint73 @SSP1166 @SSP1247 @live @api
  Scenario Outline: To verify contents of the category pages <store> <category>
    Given user navigate to "<store>" store homepage and "does" accept the cookies
  ...
  @category @Sprint71 @SSP1312 @live @api
  Scenario Outline: To verify contents of the category pages <store> <category>
    Given user navigate to "<store>" store homepage and "does" accept the cookies
    And open "TITLE_LINK" url for "<category>" category from json "CategoryContents_EN_S73.json"
  ...
  Scenario Outline: To verify contents of the category pages <store> <category>
    ...
    Examples: 
      ...
      | canada | Flashlights                            |
      | en-MX  | Lubricants, Greases & Cutting Fluids   |
      | canada | Photoelectric/Infrared                 |
      | en-MX  | Padlocks                               |

  @category @Sprint74 @SSP1346 @live @api
  Scenario Outline: To verify contents of the category pages <store> <category>
    Given user navigate to "<store>" store homepage and "does" accept the cookies
    And open "TITLE_LINK" url for "<category>" category from json "CategoryContents_EN_S74.json"
    And user wait "medium" duration for "CategoryPage.categoryPLP_label" element to "appear"
    And verify "<category>" category description with "CategoryPage.specificCategoryContent_text"
    And verify hyperlinked text in the description with "CategoryPage.spcificCategoryContentURL_link" for category "<category>" if any
    And verify innerlinks are doesnot contain "/w/"
    And verify response status code for hyperlinks is "200"
    And take screenshot
  ...
  Scenario Outline: To verify contents of the category pages <store> <category>
    ...
    Examples: 
      ...
      | uk    | DC/AC Inverters                                           |
      | en-ES | DC / DC Converters - External Plug In Adaptor             |
      | en-NL | Cameras                                                   |
      ...
      | ie    | DC / DC Converters - External Plug In Adaptor             |
      | en-FR | Cameras                                                   |
    ...
    Examples: 
      | store | category                                                  |
      | au    | Cleaners                                                  |
      | en-CN | DC / DC Converters - Linear Regulator Drop In Replacement |
      | in    | DC to DC Converters                                       |
      | au    | DC/AC Inverters                                           |
      | sg    | DC / DC Converters - External Plug In Adaptor             |
      | in    | Cleaners                                                  |
  ...
  Scenario Outline: To verify contents of the category pages <store> <category>
    ...
    Examples: 
      ...
      | en-AT | Signal Generators & Counters          |
      | en-HU | NI Training Courses                   |
      | en-DK | NI Signal generators and counters     |
      # | en-PT | NI Modules                            |
      | en-RO | NI Calibration services               |
      | en-BE | NI Controllers                        |
      | en-PL | NI Data Acquisition & Control Modules |
      | en-ES | Calibration Services                  |
      | en-SK | NI Control Accessories                |
  ...
  Scenario Outline: To verify contents of the category pages <store> <category>
    ...
    Examples: 
      ...
      | ie    | modules                                  |
      | en-ES | controller-accessories                   |
      | en-NL | controllers                              |
      | en-SE | data-acquistion-control-modules          |
      | en-DE | trainings-courses                        |
      | en-IT | modules                                  |
  ...
  Scenario Outline: Verify new content of <category> in <store>
    Given user navigate to "<store>" store homepage and "does" accept the cookies
    And open "TITLE_LINK" url for "<category>" category from json "CategoryContents_EN_S86.json"
    And user wait "medium" duration for "CategoryPage.categoryPLP_label" element to "appear"
    And verify "<category>" category description with "CategoryPage.altCategoryContent_text"
    And verify hyperlinked text in the description with "CategoryPage.altCategoryContentURL_link" for category "<category>" if any
    And verify innerlinks are doesnot contain "/w/"
